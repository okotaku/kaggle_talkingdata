...
submit.to_csv('callum-lgbsub.csv.gz', float_format='%.8f', index=False, compression='gzip')


pred_val = model.predict(val_df[inputs])
pred_df = pd.DataFrame()
pred_df['is_attributed']  = pred_val
pred_df.to_csv('callum-lgbval.csv.gz', float_format='%.8f', index=False,compression='gzip')
print('Done!')